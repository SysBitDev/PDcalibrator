...
#define BUILD_DATE   (BUILD_YEAR * 10000 + BUILD_MONTH * 100 + BUILD_DAY) //for use

#define BUILD_TIME   (BUILD_HOUR * 10000 + BUILD_MIN * 100 + BUILD_SEC) //for use


#define VERSION_MAJOR                   1
#define VERSION_MINOR                   0
#define FIRMVARE_VERSION				1
